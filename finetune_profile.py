...
def main():
    ...
    # Profile loss: use as edge replacement
    edge_weight=1.0,          # Profile gradient loss weight (moderate)
    freq_weight=0.15,         # Fourier supervision
    ssim_weight=0.8,          # Strong SSIM — recover structure
    ...
    # Profile loss settings
    use_profile_loss=True,
    num_profiles=32,
    profile_width=5,
    )

    print("=== profile FINE-TUNE ===")
    print("Config:", config)
